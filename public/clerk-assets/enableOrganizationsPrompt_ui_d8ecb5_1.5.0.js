"use strict";(globalThis.webpackChunk_clerk_ui=globalThis.webpackChunk_clerk_ui||[]).push([["533"],{7334:function(e,i,n){n.r(i),n.d(i,{EnableOrganizationsPrompt:()=>u});var r=n(4518),t=n(4180),o=n(8802),a=n(5074),s=n(7697),l=n(6705),d=n(9406),c=n(8272),p=n(1986),h=n(8307);let g=({caller:e,onSuccess:i,onClose:n})=>{let d=(0,t.ho)(),[g,u]=(0,a.useState)(!1),[f,b]=(0,a.useState)(!1),[w,C]=(0,a.useState)(null),[k,Y]=(0,a.useState)(!1),F=(0,a.useRef)(null),_=(0,s.O)(),A=(0,a.useId)(),B=!e.startsWith("use"),H=void 0!==_?.organizationSettings.forceOrganizationSelection;return(0,r.Y)(p.Z,{children:(0,r.Y)(l.Modal,{canCloseModal:!1,containerSx:()=>({alignItems:"center"}),initialFocusRef:F,children:(0,r.FD)(h.Uw,{sx:()=>({display:"flex",flexDirection:"column",width:"30rem",maxWidth:"calc(100vw - 2rem)"}),children:[(0,r.FD)(c.so,{direction:"col",sx:e=>({padding:`${e.sizes.$4} ${e.sizes.$6}`,paddingBottom:e.sizes.$4,gap:e.sizes.$2}),children:[(0,r.FD)(c.so,{as:"header",align:"center",sx:e=>({gap:e.sizes.$2}),children:[(0,r.Y)($,{isEnabled:f}),(0,r.Y)("h1",{css:[h.mk,(0,o.AH)`
                    color: white;
                    font-size: 0.875rem;
                    font-weight: 500;
                    outline: none;
                  `],tabIndex:-1,ref:F,children:f?"Organizations feature enabled":"Organizations feature required"})]}),(0,r.Y)(c.so,{direction:"col",align:"start",sx:e=>({gap:e.sizes.$0x5}),children:f?(0,r.FD)("p",{css:[h.mk,(0,o.AH)`
                      color: #b4b4b4;
                      font-size: 0.8125rem;
                      font-weight: 400;
                      line-height: 1.3;
                    `],children:[d.user&&w?`The Organizations feature has been enabled for your application. A default organization named "${w}" was created automatically. You can manage or rename it in your`:"The Organizations feature has been enabled for your application. You can manage it in your"," ",(0,r.Y)(z,{href:"https://dashboard.clerk.com/~/organizations-settings",target:"_blank",rel:"noopener noreferrer",children:"dashboard"}),"."]}):(0,r.FD)(r.FK,{children:[(0,r.FD)("p",{id:A,css:[h.mk,(0,o.AH)`
                        color: #b4b4b4;
                        font-size: 0.8125rem;
                        font-weight: 400;
                        line-height: 1.23;
                      `],children:["Enable Organizations to use"," ",(0,r.Y)("code",{css:[h.mk,(0,o.AH)`
                          font-size: 0.75rem;
                          color: white;
                          font-family: monospace;
                          line-height: 1.23;
                        `],children:B?`<${e} />`:e})," "]}),(0,r.Y)(z,{href:"https://clerk.com/docs/guides/organizations/overview",target:"_blank",rel:"noopener noreferrer",children:"Learn more"})]})}),H&&!f&&(0,r.Y)(c.so,{sx:e=>({marginTop:e.sizes.$2}),direction:"col",children:(0,r.FD)(v,{value:k?"optional":"required",onChange:e=>Y("optional"===e),labelledBy:A,children:[(0,r.Y)(y,{value:"required",label:(0,r.FD)(c.so,{wrap:"wrap",sx:e=>({columnGap:e.sizes.$2,rowGap:e.sizes.$1}),children:[(0,r.Y)("span",{children:"Membership required"}),(0,r.Y)(x,{children:"Standard"})]}),description:(0,r.FD)(r.FK,{children:[(0,r.Y)("span",{className:"block",children:"Users need to belong to at least one organization."}),(0,r.Y)("span",{children:"Common for most B2B SaaS applications"})]})}),(0,r.Y)(y,{value:"optional",label:"Membership optional",description:"Users can work outside of an organization with a personal account"})]})})]}),(0,r.Y)("span",{css:(0,o.AH)`
              height: 1px;
              display: block;
              width: calc(100% - 2px);
              margin-inline: auto;
            ...
            `}),(0,r.Y)(c.so,{justify:"center",sx:e=>({padding:`${e.sizes.$4} ${e.sizes.$6}`,gap:e.sizes.$3,justifyContent:"flex-end"}),children:f?(0,r.Y)(m,{variant:"solid",onClick:()=>{d.user?i?.():(d.redirectToSignIn(),d.__internal_closeEnableOrganizationsPrompt?.())},children:d.user?"Continue":"Sign in to continue"}):(0,r.FD)(r.FK,{children:[(0,r.Y)(m,{variant:"outline",onClick:()=>{d?.__internal_closeEnableOrganizationsPrompt?.(),n?.()},children:"I'll remove it myself"}),(0,r.Y)(m,{variant:"solid",onClick:()=>{u(!0);let e={enable_organizations:!0};H&&(e.organization_allow_personal_accounts=k),_.__internal_enableEnvironmentSetting(e).then(async()=>{let e=await d.user?.getOrganizationMemberships();C(e?.data[0]?.organization.name??null),b(!0),u(!1)}).catch(()=>{u(!1)})},disabled:g,children:"Enable Organizations"})]})})]})})})},u=e=>(0,r.Y)(d.S,{children:(0,r.Y)(g,{...e})}),f=(0,o.AH)`
  ${h.mk};
  cursor: pointer;
  display: flex;
  align-items: center;
...
`},m=(0,a.forwardRef)(({variant:e="solid",...i},n)=>(0,r.Y)("button",{ref:n,type:"button",css:[f,b[e]],...i})),x=({children:e})=>(0,r.Y)("span",{css:(0,o.AH)`
        ${h.mk};
        display: inline-flex;
        align-items: center;
        ...
        color: #2b2b34;
        white-space: nowrap;
      `,children:e}),[w,C]=(0,t.e3)("RadioGroupContext"),v=({value:e,onChange:i,children:n,labelledBy:t})=>{let o=(0,a.useId)(),s=a.useMemo(()=>({value:{name:o,value:e,onChange:i}}),[o,e,i]);return(0,r.Y)(w.Provider,{value:s,children:(0,r.Y)(c.so,{role:"radiogroup",direction:"col",gap:3,"aria-orientation":"vertical","aria-labelledby":t,children:n})})},k="1rem",Y="0.5rem",y=({value:e,label:i,description:n})=>{let{name:t,value:s,onChange:l}=C(),d=(0,a.useId)(),p=e===s;return(0,r.FD)(c.so,{direction:"col",gap:1,children:[(0,r.FD)("label",{css:(0,o.AH)`
          ${h.mk};
          display: flex;
        ...
        `,children:[(0,r.Y)("input",{type:"radio",name:t,value:e,checked:p,onChange:()=>l(e),"aria-describedby":n?d:void 0,css:(0,o.AH)`
            ${h.mk};
            position: absolute;
            width: 1px;
            height: 1px;
            ...
            white-space: nowrap;
            border-width: 0;
          `}),(0,r.Y)("span",{"aria-hidden":"true",css:(0,o.AH)`
            ${h.mk};
            position: relative;
            display: inline-flex;
            align-items: center;
          ...
          `}),(0,r.Y)("span",{css:[h.mk,(0,o.AH)`
              font-size: 0.875rem;
              font-weight: 500;
              line-height: 1.25;
              color: white;
            `],children:i})]}),n&&(0,r.Y)("span",{id:d,css:[h.mk,(0,o.AH)`
              padding-inline-start: calc(${k} + ${Y});
              font-size: 0.75rem;
              line-height: 1.33;
              color: #c3c3c6;
              text-wrap: pretty;
            `],children:n})]})},z=(0,a.forwardRef)(({children:e,css:i,...n},t)=>(0,r.Y)("a",{ref:t,...n,css:[h.mk,(0,o.AH)`
            color: #a8a8ff;
            font-size: inherit;
            font-weight: 500;
            line-height: 1.3;
            font-size: 0.8125rem;
            min-width: 0;
          `,i],children:e})),$=({isEnabled:e})=>{let[i,n]=(0,a.useState)(0);(0,a.useLayoutEffect)(()=>{if(e)return void n(e=>180*(0===e));let i=setInterval(()=>{n(e=>180*(0===e))},2e3);return()=>clearInterval(i)},[e]);let t="idle",s="warning";e&&(0===i?(t="success",s="warning"):(s="success",t="idle"));let l=e=>{switch(e){case"idle":return(0,r.Y)(h.MF,{});case"success":return(0,r.Y)(h.F3,{css:(0,o.AH)`
              width: 1.25rem;
              height: 1.25rem;
            `});case"warning":return(0,r.FD)("svg",{css:(0,o.AH)`
              width: 1.25rem;
              height: 1.25rem;
        ...
        width: 1.25rem;
        height: 1.25rem;
      `,children:(0,r.FD)("div",{css:(0,o.AH)`
          position: relative;
          width: 100%;
          height: 100%;
        ...
        `,children:[(0,r.Y)("span",{"aria-hidden":!0,css:(0,o.AH)`
            position: absolute;
            width: 100%;
            height: 100%;
          ...
          `,children:l(t)}),(0,r.Y)("span",{"aria-hidden":!0,css:(0,o.AH)`
            position: absolute;
            width: 100%;
            height: 100%;
            backface-visibility: hidden;
